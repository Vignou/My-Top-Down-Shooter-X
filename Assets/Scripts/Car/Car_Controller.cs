...
public class Car_Controller : MonoBehaviour
{
    ...
    {      
        ...
        foreach(var wheel in wheels)
        {
            ...
            float breakSensetivity = frontBrakes ? frontBrakesSensetivity : backBrakesSensetivity;

            float newBrakeTorque = brakePower * breakSensetivity * Time.deltaTime;
    ...
    public void ActivateCar(bool activate)
    {
        ...
        //This is what make the car not flying
        //if (activate)
